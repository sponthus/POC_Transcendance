...
export class UserPage extends BasePage {
	...
	protected _BodyDiv?: HTMLElement;
	...
	private async renderBodyProfile() {
		...
		this._BodyDiv.className = "bg-orange-300  bg-opacity-50 w-full h-[60%] flex items-center justify-center overflow-auto";
		...
		switch(this.StateBody){
			...
			case BodyState.HISTORY:
				...
				DisplayHistoryPage(this._BodyDiv);
				break;
			default:break;
		}
	...
	private async displayHistoryBody() {
